...
tax = calculate_progressive_tax(income) # tax is a dictionary 
print("Progressive tax for income ${}: ${:.2f}" .format(income, tax["total"]))
print("Federal Tax: ${: .2f} and State Tax: ${: .2f}" .format(tax["fed"],tax["state"]))
